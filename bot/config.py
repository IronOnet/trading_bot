...
class Config: 
    def __init__(self): 
        ...
        if not os.path.exists(CFG_FL_NAME):
            print("[WARNING]: No Configuration File (user.cfg) found! See README. Assuming default config...") 
        ...
        self.CURRENT_COIN_SYMBOL = os.environ.get("CURRENT_COIN_SYMBOL") or config.get(USER_CFG_SECTION, "current_coin_symbol") 
